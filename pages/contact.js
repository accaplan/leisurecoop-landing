                  ...
                  >
                    ...
                    <div className="flex-wrap self-end w-full lg:flex">
                      ...
                      <div className="lg:w-1/2 mb-5 lg:mb-0">
                        ...
                        <p className="text-off-black">{contact.telephone && (<a className="inline-block" href={`tel:${contact.telephone}`}> {contact.telephone}</a>)} <br /> <a href="https://www.leisure.coop" aria-label="Go to Home" rel="noreferrer noopener" className="text-blue">www.leisure.coop</a></p>
